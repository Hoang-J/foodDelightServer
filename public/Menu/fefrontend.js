...
fetch('https://food-delight-server-fa18xhljl-hoang-js-projects.vercel.app/menu?all')
...
form.addEventListener('submit', () => {
    ...
    fetch('https://food-delight-server-fa18xhljl-hoang-js-projects.vercel.app/order', {
        method: "POST", 
        body: url,
        headers: {
